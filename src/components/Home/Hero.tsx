    ...
    <CircuitBoard>
      <div className="relative z-50 flex flex-col items-center justify-center w-full h-full text-center container mx-auto px-5 py-10 md:py-0 lg:lg:px-0 text-white">
        <motion.div
          ...
          className="py-2 px-6 bg-[#3c3e45]/40 rounded-full mb-4 2xl:mb-6 flex items-start md:items-center gap-2"
        >
        ...
        <motion.h1
          ...
          className="text-2xl lg:text-6xl font-semibold leading-normal lg:leading-[40px] 2xl:leading-[60px]"
        >
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, delay: 0.6 }}
        >
          <p className="text-white max-w-[800px] mx-auto mt-10 2xl:mt-[64px] mb-3 md:mb-10 text-base md:text-lg">
