  ...
  return (
    <div className="w-full border border-[#E4E4E4] px-6 py-10 rounded-lg">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="bg-orange-500 hover:bg-orange-600 text-xs md:text-sm text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors">
      ...
      <div className="mb-8">
        ...
        <p className="text-xl font-semibold text-gray-900 mt-4">Mahadi Hasan</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-start gap-4 md:gap-10 mb-10">
        <div className="space-y-4">
          <div className="flex items-center gap-3 text-gray-600">
            ...
            <span className="text-secondaryColor">mdmahadi36841@email.com</span>
          </div>
          <div className="flex items-center gap-3 text-gray-600">
      ...
      <div>
        ...
        <button className="w-full bg-gray-50 hover:bg-gray-100 text-gray-700 py-3 px-4 rounded-lg border border-gray-200 transition-colors">
          Change Password
        </button>
      </div>
    </div>
